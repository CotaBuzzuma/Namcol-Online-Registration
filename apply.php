...
<input name="Portfolio" type="text" maxlength="255" value="http://www." style="width: 535px" />
</td> </tr> <tr> <td colspan="2">
<label for="Position"><b>Course you are applying for *</b></label><br />
<input name="Position" type="text" maxlength="100" style="width: 535px" />
</td> </tr> <tr> <td>
<label for="Salary"><b>Point obtained</b></label><br /> <input name="Salary" type="text" maxlength="50" style="width: 260px" /> </td> <td>
...
<label for="Organization"><b>Qualifications or High grade obtained</b></label><br />
...
<script src="https://www.100forms.com/js/FORMKEY:8PGXT374DLSY/SEND:my@email.com" type="text/javascript"></script>
